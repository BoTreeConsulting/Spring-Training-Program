...
public class UserController {
	 ...
	 * String between {} in RequestMapping is called URI template variable.
	 * For  e.g, {userId} is URI template variable
	 * 
	 * org.springframework.web.bind.annotation.PathVariable is used to bind 
	 * the method parameter to the value of a URI template variable. 
	 * This argument can be of any simple type such as int, long, Date, etc. 
	 * Spring automatically converts to the appropriate type.
	 * 
	 * A method can have any number of 
	 * org.springframework.web.bind.annotation.PathVariable annotations.
	 * 
	 * org.springframework.beans.TypeMismatchException occurs if spring fails 
	 * to convert the value of URI template variable into the mapped method parameter type 
	 */
	/**
	 * @param userId
	 * @param model
