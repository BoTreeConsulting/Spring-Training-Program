...
public class AuthorUtil extends EntityUtil<Author, Long> {
	...
	private static final String[][] TEST_AUTHORS = {
		...
		{"Zig", "Ziglar", "40"},
		{"Robin", "Sharma", "40"},
		{"Swami", "Anubhavanand", "45"},
		{"Swami", "Chinmayanand", "45"},
		{"Swami", "SivanandSaraswati", "45"},
	};
	...
	public static final List<Author> getTestAuthors() {
		...
		for (String[] testAuthor : TEST_AUTHORS) {
			testAuthors.add(getTestAuthor(testAuthor[0], testAuthor[1], new Integer(testAuthor[2])));
		}
		return testAuthors;
	}
	
	private static Author getTestAuthor(String firstName, String lastName, Integer age) {
